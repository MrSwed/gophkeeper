	...
	tests := []struct {
		...
		},
		{
			...
			wantStrOut: [][]string{
				...
				18: {cfg.PromptNewSyncPassword, cfg.PromptSyncConfirmPassword, "Error", "validation", "password"},
				19: {cfg.PromptNewSyncPassword, cfg.PromptSyncConfirmPassword, "User sync finished"},
