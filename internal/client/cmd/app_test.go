	...
	tests := []struct {
	...
	}{
		{
			...
			wantStrOut: [][]string{
				...
				6:  {"User testName configuration loaded", cfg.PromptMasterPs, cfg.PromptNewMasterPs, cfg.PromptConfirmMasterPs},
				7:  {"text-key-1", "some description", "some text data"},
				8:  {"Switching to profile..  " + "someOtherUser"},
				10: {"Current profile someOtherUser", "User someOtherUser configuration loaded", cfg.PromptNewMasterPs, cfg.PromptConfirmMasterPs},
				11: {"Current profile someOtherUser", "User someOtherUser configuration loaded", cfg.PromptMasterPs, cfg.PromptNewMasterPs, cfg.PromptConfirmMasterPs},
		...
		},
		{
			...
			commands: [][]string{
				...
				5:  {"sync", "password"},
				6:  {"sync", "delete"},
				7:  {"config", "user", "--server", s.getServerAddress()},
				8:  {"sync", "now"},
				9:  {"sync", "password"},
				10: {"sync", "delete"},
				11: {"sync", "register"},
				12: {"config", "user", "-e", "newSyncUser@email.localhost"},
				13: {"sync", "register"},
				14: {"sync", "register"},
				15: {"sync", "register"},
				16: {"sync", "now"},
				...
				18: {"sync", "password"},
				19: {"sync", "password"},
				20: {"profile", "use", "newSyncUser2"},
				21: {"config", "user", "--server", s.getServerAddress()},
				22: {"config", "user", "-e", "newSyncUser@email.localhost"},
				23: {"sync", "register"},
				24: {"sync", "now"},
				25: {"sync", "delete"},
				26: {"sync", "now"},
			...
			wantStrOut: [][]string{
				...
				5:  {"The address of the synchronization server is not set"},
				6:  {"The address of the synchronization server is not set"},
				7:  {"User configuration: set `server` = `" + s.getServerAddress() + "`"},
				8:  {"This client is not registered on the server yet"},
				9:  {"This client is not registered on the server yet"},
				10: {"This client is not registered on the server yet"},
				11: {"The email is not specified in the configuration"},
				12: {"User configuration: set `email` = `newSyncUser@email.localhost`"},
				13: {"Registering this client at server with email newSyncUser@email.localhost", "If you have not yet registered on the server with your email, come up with a new synchronization password, a new account will be created for you, after which this client will be able to synchronize", "failed to register client", "validation", "password"},
				14: {"Registering this client at server with email newSyncUser@email.localhost", "If you have not yet registered on the server with your email, come up with a new synchronization password, a new account will be created for you, after which this client will be able to synchronize", "The synchronization token has been successfully received", "Congratulations! The client is successfully registered on the server, the synchronization token is saved in the settings."},
				15: {"This client is already registered on the server. You can run synchronization"},
				16: {"Start synchronization with server", "User sync finished, no new data received", "User synchronization finished", "Data synchronization finished", "Synchronization status"},
				17: {"Synchronization status:", "last_sync_at", "last_sync_at", `"updated": 2`},
				18: {cfg.PromptNewSyncPs, cfg.PromptSyncConfirmPs, "Error", "validation", "password"},
				19: {cfg.PromptNewSyncPs, cfg.PromptSyncConfirmPs, "User sync finished"},
				20: {"Switching to profile..  ", "newSyncUser2"},
				21: {"User configuration: set `server` = `" + s.getServerAddress() + "`"},
				22: {"User configuration: set `email` = `newSyncUser@email.localhost`"},
				23: {"Registering this client at server with email newSyncUser@email.localhost", "If you have not yet registered on the server with your email, come up with a new synchronization password, a new account will be created for you, after which this client will be able to synchronize", "The synchronization token has been successfully received", "Congratulations! The client is successfully registered on the server, the synchronization token is saved in the settings."},
				24: {"Start synchronization with server", "User sync finished, no new data received", "User synchronization finished", "Data synchronization finished", "Synchronization status"},
				25: {"The user has been successfully deleted from the server", "the client token has been deleted from the local configuration"},
				26: {"This client is not registered on the server yet"},
			},
			wantNoStrOut: [][]string{
				0:  {},
				1:  {},
				...
				12: {},
				13: {},
				14: {"This client is already registered on the server. You can run synchronization.", "The email is not specified in the configuration, please set it by command", "failed to get password", "failed to register client"},
				15: {},
				16: {"failed to load config", "prepare synchronization failed", "user synchronization failed", "failed to marshal sync.status", "User sync finished, user data updated from server", "data synchronization failed", "failed to hex Decode String encryptedSyncToken: invalid byte", "failed to get encryption token", "failed to decrypt synchronization token"},
			},
			inputs: [][]string{
				0:  {},
				1:  {"somePass", "somePass"},
				...
				16: {},
				17: {},
				18: {"simplePass", "simplePass"},
				19: {"Pa$$w0rd1", "Pa$$w0rd1"},
				20: {},
				21: {},
				22: {},
				23: {"Pa$$w0rd1", "somePass", "somePass"},
				24: {},
				25: {},
				26: {},
			},
