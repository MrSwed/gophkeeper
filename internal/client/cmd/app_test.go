	...
	tests := []struct {
		...
		},
		{
			...
			wantStrOut: [][]string{
				...
				20: {"The user has been successfully deleted from the server", "the client token has been deleted from the local configuration"},
				21: {"This client is not registered on the server yet"},
			},
			wantNoStrOut: [][]string{
				0:  {},
				1:  {},
